<?php
    ...
    $lblEmail = isset($_SESSION['email']);
    $lblNickname = isset($_SESSION['nickname']);
?>
<!doctype html>
<html>
    <head>
                ...
                <ul>
                    ...
                    <li>Maak een formulier dat er als volgt uitziet:
                        ...
                        <div class="facade-minimal" data-url="http://www.app.local/opdracht-sessions-pagina-01-registratie.php">
                            ...
                            <form action="opdracht-session.php" method="POST">
                                <ul>
                                    <li>
                                        <label for="email">e-mail</label>
                                        <input type="text" id="email" name="email" value="<?= $lblEmail ?>">
                                    </li>
                                    <li>
                                        <label for="nickname">nickname</label>
                                        <input type="text" id="nickname" name="nickname" value="<?= $lblNickname ?>">
                                    </li>
                                </ul>
