<?php
    ...
    $dieren1 = array("paard","hond","kat","vis","vogel","spin","muis","hamster","beer","bij");
    $dieren2 = array("paard" => "hoeven","hond" => "staart","kat" => "melk","vis" => "vijver","vogel" => "vleugel","spin" => "spinnenweb","muis" => "kaas","hamster" => "rad","beer" => "bruin","bij" => "honing");

    $voertuigen = array("boot" => array("watervoertuigen"),"auto" => array("landvoertuigen"),"fiets" => array("landvoertuigen"),"vliegtuig" => array("luchtvoertuigen"),"duikboot" => array("watervoertuigen"));
?>
<!doctype html>
<html>
    <head>
    ...
    <body class="web-backend-opdracht">
        ...
        <section class="body">
            ...
            <ul>
                ...
                <p>Wanneer je een <code>var_dump</code> van deze array doet, ziet het resultaat er ongeveer als volgt uit: <?= var_dump($voertuigen) ?></p>
            ...
            <ul>
                ...
                <?= $getallen[0]*$getallen[1]*$getallen[2]*$getallen[3]*$getallen[4] ?>
                ...
                <?php
                    ...
                    for($j=0;$j<count($getallen);$j++)
                    {
                        echo $getallen[$j]+$getallen2[$j];
                    }
